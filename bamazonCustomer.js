...
var lookup = {
                ...
                .prompt([
                  {
                    type: "list",
                    message:
                      "\nPlease confirm, do you wish to purchase (" +
                      answers.numberToPurchase +
                      ") of this product:\n" +
                      lookup.product,
                    choices: ["Yes", "No"],
                    name: "whichOne"
  ...
  checkInventoryStock: function(res, product) {
    ...
    if (res[lookup.index].stock_quantity === 0) {
      ...
      console.log(
        "\nIt seems that this item is in short supply and (" +
          res[lookup.index].stock_quantity +
